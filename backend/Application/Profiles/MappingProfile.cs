...
namespace backend.Application.Profiles
{
	public class MappingProfile : Profile
	{
		public MappingProfile()
		{
			...
			CreateMap<AuthenticationResponseDTO, User>().ReverseMap().ForMember(
				dest => dest.Role,
				opt =>
				...
				opt => opt.MapFrom(src => UserNotificationSettingSharedDto.FromJson(src.NotificationSettings)
				                          ?? new UserNotificationSettingSharedDto()));
			...
			CreateMap<UserChatDto, UserChatDtoResponse>().ReverseMap();
			...
			CreateMap<NotificationResponseDto, Notification>().ReverseMap()
				.ForMember(
					dest => dest.Sender,
					opt =>
						opt.MapFrom(src => new UserNotificationSharedResponse
						{
							Id = src.Sender.Id,
