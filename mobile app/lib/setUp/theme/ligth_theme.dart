    ...
    return ThemeData(
        ...
        colorScheme: ThemeData.from(colorScheme: ThemeData.light().colorScheme)
            ...
            .copyWith(
              ...
              tertiaryContainer: LightAppPalette.tertiary,
              onSurface: LightAppPalette.onSurface,
              surfaceDim: LightAppPalette.surface,
              ...
              onPrimaryContainer: LightAppPalette.onPrimaryContainer,
              scrim: LightAppPalette.scrim,
            ),
