...
class RatingOverviewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return builderDetails(
        AppLocalizations.of(context)!.ratingOverviewWidget_ratingOverview,
        Container(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    '$totalReviews ${AppLocalizations.of(context)!.ratingOverviewWidget_reviews}',
                    style: const TextStyle(
                      fontSize: 16,
                      color: Colors.grey,
                    ),
      ...
      children: [
        ...
        Expanded(
          child: LinearProgressIndicator(
            value: ratingCount / (totalReviews == 0 ? 1 : totalReviews),
