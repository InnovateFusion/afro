...
class DisConnectFromTiktokUseCase extends UseCase<UserEntity, Params> {
  final UserRepository repository;

  DisConnectFromTiktokUseCase(this.repository);

  @override
  Future<Either<Failure, UserEntity>> call(Params params) async {
    return await repository.disConnectFromTiktok(
